...
export const alt = `Rai Dispatch — You drive the miles. We manage the loads. Truck dispatch fees ${DISPATCH_RATE_RANGE} by equipment.`;
...
export default function Image() {
  return new ImageResponse(
    <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100%', background: '#101827', color: '#fff', padding: '72px', justifyContent: 'space-between' }}>
      <div style={{ display: 'flex', fontSize: 30, color: '#ff6269', letterSpacing: 5 }}>RAI DISPATCH / TRUCK DISPATCH SERVICES</div>
      <div style={{ display: 'flex', flexDirection: 'column', fontSize: 72, lineHeight: 1.15, fontWeight: 700 }}>
        <span>You drive the miles.</span>
        <span style={{ color: '#ff6269' }}>We manage the loads.</span>
      </div>
