...
export default function TestimonialsPageClient() {
  return <>
    ...
    <section className="section-padding bg-white"><div className="container-custom"><div className="grid md:grid-cols-2 gap-6">{[
      ...
      { title: 'Understand the fee', text: 'Percentage dispatch fees are up to 5%. Confirm the exact rate, gross-revenue basis, billing schedule, and cancellation terms in your agreement.' },
      { title: 'A clear point of contact', text: 'Agree on your dispatcher contact, update preferences, and support hours during onboarding so you know how to reach the team.' },
