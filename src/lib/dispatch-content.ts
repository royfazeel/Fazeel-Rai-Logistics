...
export const EQUIPMENT_CONTENT: DispatchContent[] = [
  {
    ...
    metaTitle: 'Dry Van Dispatch Services | Up to 5% Fee',
    description: 'Dry van dispatch for owner-operators and fleets across the lower 48. Load search, rate negotiation and lane planning with a dispatch fee up to 5%.',
    ...
    sections: [
      ...
      { id: 'support', title: 'Keep the dispatch desk and the driver aligned', paragraphs: ['We support load search, broker communication, rate-confirmation review and appointment follow-ups. You approve the freight and the agreed terms. Your dispatcher uses the truck status and availability you provide to avoid planning the next pickup around an unrealistic arrival.', 'Dispatch fees are up to 5% under the agreed percentage plan. The agreement should identify the billing base and treatment of fuel surcharge and accessorials, so you can compare the full cost before starting.'] },
    ],
  ...
  {
    slug: 'reefer', title: 'Reefer dispatch services', metaTitle: 'Reefer Dispatch Services | Up to 5% Fee',
    description: 'Refrigerated truck dispatch with temperature-instruction review, appointment coordination and rate negotiation. Nationwide carrier support at up to 5%.',
    ...
    sections: [
      ...
      { id: 'economics', title: 'Include the refrigeration costs in the decision', paragraphs: ['Reefer fuel, washouts and waiting time can affect a load even when its posted rate looks attractive. Compare the complete trip with your own operating costs and the next realistic pickup opportunity.', 'Our dispatch fee is up to 5% under the agreed percentage plan. We explain the billing base before onboarding and support rate negotiation, load booking and paperwork coordination. We do not promise produce-season rates or a fixed number of loads.'] },
    ],
  ...
  {
    slug: 'flatbed', title: 'Flatbed dispatch services', metaTitle: 'Flatbed Dispatch Services | Up to 5% Fee',
    description: 'Flatbed dispatch for open-deck carriers. Review dimensions, tarping, securement needs and lanes before booking, with dispatch fees up to 5%.',
  ...
  {
    slug: 'box-truck', title: 'Box truck dispatch services', metaTitle: 'Box Truck Dispatch Services | Up to 5% Fee',
    description: 'Box truck dispatch for straight-truck carriers. Equipment-fit reviews, load search and booking support for regional or OTR work at up to 5%.',
    eyebrow: 'Straight trucks. Specific load requirements.',
    intro: 'A box truck load must fit the actual truck, door opening and delivery method. Rai Dispatch helps straight-truck carriers assess suitable regional and over-the-road opportunities with a clear dispatch fee up to 5%.',
  ...
  {
    slug: 'power-only', title: 'Power only dispatch services', metaTitle: 'Power Only Dispatch Services | Up to 5% Fee',
    description: 'Power only dispatch with trailer-interchange, pickup and return requirements reviewed. Carrier-approved bookings with a dispatch fee up to 5%.',
  ...
  {
    slug: 'step-deck', title: 'Step deck dispatch services', metaTitle: 'Step Deck Dispatch | Equipment & Lane Review',
    description: 'Request step deck dispatch for open-deck freight. Review upper and lower deck dimensions, loading needs and lanes. Availability assessed before onboarding.',
    ...
    sections: [
      ...
      { id: 'planning', title: 'Evaluate the complete lane and schedule', paragraphs: ['Machine pickup times, loading access and unloading equipment can control the trip. Ask whether the site can load your trailer configuration, whether an appointment is firm and how extra work is compensated.', 'If the operation fits our service, we discuss load search, broker communication and a percentage dispatch fee up to 5% in the agreement. Specialized support and available freight are reviewed individually.'], bullets: ['Share both deck lengths, deck heights and payload.', 'Identify ramps or loading equipment available.', 'Confirm cargo dimensions and any permit-dependent scope before approval.'] },
    ],
  ...
  {
    slug: 'hotshot', title: 'Hotshot dispatch services', metaTitle: 'Hotshot Dispatch | Equipment & Lane Review',
    description: 'Discuss hotshot dispatch for your pickup and trailer configuration. Equipment, payload, authority and lane review before service confirmation. Fees up to 5%.',
  ...
  {
    slug: 'cargo-van', title: 'Cargo van and sprinter van dispatch', metaTitle: 'Cargo Van & Sprinter Dispatch | Availability Review',
    description: 'Request a cargo van or sprinter van dispatch review. Discuss dimensions, payload, expedited freight and lanes before confirming availability and fees up to 5%.',
    ...
    sections: [
      ...
      { id: 'economics', title: 'Assess waiting and repositioning as part of the trip', paragraphs: ['Smaller freight can still involve a long empty drive, a narrow pickup window or unpaid waiting. Evaluate total time and miles alongside the rate, especially when the destination has limited next-load options.', 'If service is confirmed, the percentage fee is up to 5% under the written agreement. You approve the load and its handling requirements; we do not promise earnings or imply that every van qualifies for every platform.'], bullets: ['Give exact door openings and the narrowest usable interior width.', 'Clarify delivery access and unloading responsibility.', 'Set a maximum empty-mile radius and realistic response time.'] },
    ],
...
export const SERVICE_CONTENT: DispatchContent[] = [
  {
    ...
    faqs: [
      ...
      { question: 'Is negotiation included in the dispatch fee?', answer: 'Rate negotiation is part of our dispatch support. The percentage plan is up to 5%; scope, billing base and any specific exclusions are agreed before service.' },
    ],
...
export const GUIDES: CarrierGuide[] = [
  {
    ...
    sections: [
      ...
      { id: 'costs', title: '2. Include dispatch and operating costs', paragraphs: ['If a 5% dispatch fee applies to the full $2,000 in this example, the fee is $100. The remaining $1,900 is about $2.11 per known total mile before fuel, maintenance, tires, insurance, financing, driver pay, taxes and other expenses. It is not profit.', 'Use your own recent records for fuel consumption and operating costs. Avoid subtracting a cost twice: if your all-in cost-per-mile figure already includes insurance or maintenance, do not add the same expense again. Fixed costs still matter during days the truck does not move.'] },
  ...
  {
    slug: 'truck-dispatch-fees', title: 'Truck dispatch fees: what to compare', metaTitle: 'Truck Dispatch Fees Explained | Up to 5% Pricing',
    description: 'Understand percentage dispatch fees, billing bases and service scope. See how a 5% fee is calculated and what to ask before signing an agreement.',
    eyebrow: 'Carrier guide · Dispatch pricing', readTime: '5 minute read', published: '2026-09-24',
    intro: 'The percentage is only one part of a dispatch quote. A useful comparison also covers what revenue the fee applies to, which services are included, when invoices are due and how the agreement ends.',
    highlights: ['Compare the billing base', 'Read the included scope', 'Get terms in writing'],
    sections: [
      { id: 'percentage', title: 'How a percentage dispatch fee works', paragraphs: ['A percentage plan charges an agreed share of an agreed revenue base. At 5%, a $2,000 billing base produces a $100 dispatch fee. At the same percentage, a $5,000 billing base produces a $250 fee. These examples illustrate the calculation and do not predict earnings.', 'Rai Dispatch advertises percentage dispatch fees up to 5%. Confirm your exact rate and the revenue items included in the billing base in the signed agreement. A dispatch fee is an operating expense; the balance after that fee is not your net profit.'], table: { caption: 'Example fee calculations at 5%', headers: ['Agreed billing base', 'Dispatch fee', 'Before other expenses'], rows: [['$2,000', '$100', '$1,900'], ['$5,000', '$250', '$4,750'], ['$8,000', '$400', '$7,600']] } },
      { id: 'base', title: 'Ask what counts toward the billing base', paragraphs: ['Two quotes that both say 5% may produce different invoices. Ask whether the fee applies to linehaul only or also to fuel surcharge, detention, layover, extra stops, tarping and other accessorials. Clarify how a cancellation, unpaid load or payment dispute is handled.', 'Put those answers in the agreement and compare a sample invoice with a sample rate confirmation. That exercise often reveals more than comparing headline percentages alone.'] },
    ...
    faqs: [
      { question: 'Does “up to 5%” mean every agreement is exactly 5%?', answer: 'It states a maximum for the advertised percentage plan. Your specific rate and billing base must be confirmed in the agreement before service begins.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'cost', title: '4. Compare fees and scope in writing', paragraphs: ['Review the percentage or fixed fee, billing base, invoice timing, cancellation terms and included tasks. Ask whether accessorials, cancelled loads or disputed payments affect dispatch billing.', 'Rai Dispatch’s advertised percentage fee is up to 5%, with terms confirmed before service. The same questions should be asked of us as of any other provider. A fee comparison is meaningful only when the included scope and calculation base are comparable.'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'agreement', title: '4. Review the dispatch agreement', paragraphs: ['Confirm the service scope, percentage or other fee structure, billing base, invoice timing and cancellation terms. Rai Dispatch advertises a percentage fee up to 5%, with the exact terms agreed before service.', 'Set the load-approval process and identify authorized carrier contacts. Discuss how rate confirmations, signed delivery records and accessorial documents will be exchanged. If you use factoring, clarify any relevant document and broker-approval process with that provider.'] },
